...
def evaluate():
    ...
    init_time = train_time = ctr_time = topk_time = 0
    ...
    ndcg5 = np.mean([
        nDCG(
            user_item_lists[index],
            user_pos_items[user],
            user_train_pos_items[user]
        )
    ...
    return (
        auc, ndcg5,
        init_timeout, train_timeout, ctr_timeout, topk_timeout,
...
if __name__ == '__main__':
    ...
    print(f"⏱ CTR Eval Time       : {ctr_time:.2f} seconds")
    print(f"⏱ TopK Eval Time      : {topk_time:.2f} seconds")
    print("------------------------")
